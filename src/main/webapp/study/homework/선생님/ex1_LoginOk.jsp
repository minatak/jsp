...
<%
	...
	if((mid.equals("admin") && pwd.equals("1234")) ||(mid.equals("atom") && pwd.equals("1234"))) {
		...
		out.print("location.href='"+request.getContextPath()+"/study/homework/선생님/ex1_Main.jsp?mid="+mid+"';"); 
		out.print("</script>");
	}
	else {
		...
		out.print("location.href='"+request.getContextPath()+"/study/homework/선생님/ex1_Login.jsp';");
		out.print("</script>");
	}
%>