...
<div class="container">
  ...
  <form name="myform" method="post">
    ...
    <div><textarea rows="5" name="introduce" class="form-control mt-1" >자기소개입니다.</textarea></div>
    <div><input type="button" value="전송1" onclick="fCheck('OK')" class="btn btn-success form-control mt-1"/></div>
