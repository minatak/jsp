    ...
    <table class="table table-bordered text-center">
      ...
      <tr>
        <td colspan="2">
			    ...
			    <a href="t3_ApplicationCheck.jsp" class="btn btn-primary mr-3 btn-sm">어플리케이션 확인</a>
			    <a href="t3_ApplicationDelete.jsp" class="btn btn-danger mr-3 btn-sm">부분어플리케이션 삭제</a>
        </td>
      </tr>
    </table>
  </form>  
