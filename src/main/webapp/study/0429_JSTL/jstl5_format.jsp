...
<div class="container">
  ...
  <div class="text-right">
    ...
    <button type="button" onclick="location.href='jstl4_function.jsp';" class="btn btn-secondary btn-sm">JSTL Function</button>
  </div>
	<hr/>

	<pre>
		사용용도 : 형식 문자열을 표현(지정)할 때 사용한다. 예) 쉼표, 통화량(화폐) 단위, 백분율, 날짜형식 등)
		사용법 : < fmt : 명령어... value="$ {값/변수} 
	</pre>
