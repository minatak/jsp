...
%>
	...
	<hr/>
	<h4>파라메터를 통해서 넘어온 값의 처리 (QueryString 형식)</h4>
	<div>Form 태그의 get/post 방식의 전송이나, url을 통한 값의 전송 (주소?변수=값1&변수2=값2...) 되는 값의 처리</div>  
	<div>주소창에 현재 주소 뒤에 '?mbc=200&kbs=50' 을 입력 후 아래 내용을 확인하세요.<br/>
		mbc = ${param.mbc}<br/>
		kbs = ${param.kbs}<br/>
