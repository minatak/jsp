...
<div class="container">
  <form name="myform" method="post" action="${ctp}/database/JoinOk">
    <table class="table table-bordered text-center">
      ...
      <tr>
        <th>성명</th>
        <td><input type="text" name="name" placeholder="성명을 입력하세요" required class="form-control"/></td>
      </tr>
      <tr>
        <th>나이</th>
        <td><input type="number" name="age" placeholder="나이를 입력하세요" class="form-control"/></td>
      </tr>
      <tr>
        <th>성별</th>
        <td class="text-left">
      ...
      <tr>
        <th>주소</th>
        <td><input type="text" name="address" placeholder="주소를 입력하세요" class="form-control"/></td>
      </tr>
      <tr>
        <td colspan="2">
