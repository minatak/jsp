...
<div class="container">
	<div>
	  ...
	  <form name="myform">
	    ...
	    <div>
	      <input type="button" value="아이디검색 1" onclick="idCheck1()" class="btn btn-primary mt-2 mr-2"/>
	      <input type="button" value="아이디검색 2" onclick="idCheck2()" class="btn btn-secondary mt-2 mr-2"/>
	      <input type="button" value="아이디검색 3" onclick="idCheck3()" class="btn btn-success mt-2 mr-2"/>
	      <input type="button" value="아이디검색 4" onclick="idCheck4()" class="btn btn-success mt-2 mr-2"/>
	    </div>
	  </form>
	  <hr/>
