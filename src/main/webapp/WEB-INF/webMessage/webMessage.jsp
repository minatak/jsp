...
<div id="leftWindow">
	<p><br/></p>
	<p><a href="WebMessage.wm?mSw=0">메세지 작성</a></p>
	<p><a href="WebMessage.wm?mSw=1&mFlag=11">받은 메세지</a></p>
	<p><a href="WebMessage.wm?mSw=2">새 메세지</a></p>
	<p><a href="WebMessage.wm?mSw=3&mFlag=13">보낸 메세지</a></p>
	<p><a href="WebMessage.wm?mSw=4">수신확인</a></p>
	<p><a href="WebMessage.wm?mSw=5&mFlag=15">휴지통</a></p>
	<p><a href="javascript:wmDeleteAll()">휴지통 비우기</a></p>
</div>
<div id="rightWindow">
	<p>
		<c:if test="${mSw == 0}">
